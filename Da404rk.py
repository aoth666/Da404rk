...
__  _ _ _     _ _____             __ __   _  _    ___  _
| |/ (_) |   | | ____|_ __ ___   _| || |_| || |  ( _ )/ |
| ' /| | |   | |  _| | '__/ __| |_  ..  _| || |_ / _ \| |
| . \| | |___| | |___| |  \__ \ |_  ..  _|__   _| (_) | |
|_|\_\_|_____|_|_____|_|  |___/   |_||_|    |_|  \___/|_|
...
def show_menu():
    print(Fore.WHITE + "─" * 50)
    print(Fore.LIGHTRED_EX + " " + Fore.LIGHTWHITE_EX + "fuck kids | made by kyoja" + Fore.LIGHTRED_EX + " ")
    print(Fore.WHITE + "─" * 50)
...
async def about_us():
    ...
    print(Fore.CYAN + "═" * 50)
    print(Fore.YELLOW + " • Tool Name : " + Fore.GREEN + "Da404rkv1")
    print(Fore.YELLOW + " • Version : " + Fore.GREEN + "v1.0")
    print(Fore.YELLOW + " • Developer : " + Fore.GREEN + "kyoja")
    print(Fore.YELLOW + " • Contact : " + Fore.GREEN + "@its-Angel-t7b")
...
async def full_nuke(guild):
    print(Fore.LIGHTRED_EX + "\n[⚠] Starting Full Nuke: Da404rk\n" + Style.RESET_ALL)
    try:
        await guild.edit(name="hacked by group#kyoja")
