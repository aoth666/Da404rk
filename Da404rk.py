...
██║ ╚██╗██║███████╗███████╗███████╗██║  ██║██████╔╝  ╚██╔═██╔══╝╚════██║╚█████╔╝███████╗
╚═╝  ╚═╝╚═╝╚══════╝╚══════╝╚══════╝╚═╝  ╚═╝╚═════╝    ╚═╝ ╚═╝        ╚═╝ ╚════╝ ╚══════╝ \n""" + Style.RESET_ALL)
    print(Fore.RED + "killersXploit v1" + Style.RESET_ALL)
...
def show_menu():
    ...
    print(Fore.RED + "[3]" + Fore.LIGHTWHITE_EX + " Nuker#Dark (Full Nuke)")
    ...
    print(Fore.RED + "[E]" + Fore.LIGHTWHITE_EX + " Exit")
    print(Fore.WHITE + "─" * 50)
...
async def about_us():
    ...
    print(Fore.CYAN + "═" * 50)
    print(Fore.YELLOW + " • Tool Name : " + Fore.GREEN + "killersXpliot")
